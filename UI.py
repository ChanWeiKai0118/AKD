...
def save_to_gsheet(data, sheet_name):
    ...
    if sheet_name == "chemo data":
        ...
        row[16] = f'=IFNA(INDEX("lab data"!H:H, MATCH(1, ("lab data!A:A" = B{last_row}) * ("lab data!E:E" = MAX(FILTER("lab data!E:E", ("lab data!A:A" = B{last_row}) * ("lab data!E:E" <= F{last_row}) * ("lab data!E:E" >= F{last_row} - 30) * ("lab data!H:H" <> "")))) * ("lab data!H:H" <> ""), 0)), "")'
