...
def save_to_gsheet(data, sheet_name):
    ...
    if sheet_name == "chemo_data":
        ...
        row[23] = f'=IF(MATCH(B{last_row}, B$2:B{last_row}, 0) = ROW()-1, AA{last_row}, INDEX(Z$2:Z{last_row-1}, MATCH(B{last_row}, B$2:B{last_row-1}, 0)))'
