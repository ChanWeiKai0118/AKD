...
def save_to_gsheet(data, sheet_name):
    ...
    if sheet_name == "chemo_data":
        ...
        row[31] = f'=IF(MATCH(B{last_row}, B$2:B{last_row}, 0) = ROW()-1, AG{last_row}, INDEX(AB$2:AB{last_row-1}, MATCH(B{last_row}, B$2:B{last_row-1}, 0)))'
        ...
        row[35] = f'=IF(MATCH(B{last_row}, B$2:B{last_row}, 0) = ROW()-1, AK{last_row}, INDEX(AB$2:AB{last_row-1}, MATCH(B{last_row}, B$2:B{last_row-1}, 0)))'
        ...
        row[38] = f'=IF(AJ{last_row}="", "", AJ{last_row} - AK{last_row})'
        row[39] = f'=IF(MATCH(B{last_row}, B$2:B{last_row}, 0) = ROW()-1, AO{last_row}, INDEX(AB$2:AB{last_row-1}, MATCH(B{last_row}, B$2:B{last_row-1}, 0)))'
        ...
        row[42] = f'=IF(AN{last_row}="", "", AN{last_row} - AO{last_row})'
        row[43] = f'=IF(MATCH(B{last_row}, B$2:B{last_row}, 0) = ROW()-1, AS{last_row}, INDEX(AB$2:AB{last_row-1}, MATCH(B{last_row}, B$2:B{last_row-1}, 0)))'
        ...
        row[46] = f'=IF(AR{last_row}="", "", AR{last_row} - AS{last_row})'
